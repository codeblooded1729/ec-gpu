...
mod test {
    ...
    use ec_gpu::fr::Curve as MNT4;
    use ark_bls12_377::constraints::PairingVar as MNT4PairingVar;
    type MNT4Fr = <MNT4 as Pairing>::ScalarField;
    type MNT6Fr = <MNT4 as Pairing>::BaseField;
